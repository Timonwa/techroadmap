  ...
  return (
    <>
      ...
      <ResourceSection id="c">
        ...
        <ResourceSectionBody>
          <p>
            ...
            Ritchie. C was originally developed for UNIX operating system to
            beat the issues of previous languages such as B, BCPL, etc. The UNIX
            operating system development started in the year 1969, and its code
          ...
          <ResourceCard>
            ...
            <ResourceCardLinks>
              ...
              <ResourceLink>
                ...
                >
                  C Full Course - Learn to code today ~ Bro Code
                </a>
              </ResourceLink>
            </ResourceCardLinks>
          </ResourceCard>
          ...
          <ResourceCard>
            ...
            <ResourceCardLinks>
              <ResourceLink>
                <a
                  target="_blank"
                  href="https://www.udemy.com/course/c-programming-2019-master-the-basics/?ranMID=39197&ranEAID=JVFxdTr9V80&ranSiteID=JVFxdTr9V80-o0Hwi9OaKJw93uZ67mUGHA&LSNPUBID=JVFxdTr9V80&utm_source=aff-campaign&utm_medium=udemyads"
                >
          ...
          <ResourceCard>
            ...
            <ResourceCardLinks>
              <ResourceLink>
                ...
                >
                  15+ C Projects Ideas With Source Code ~ interviewbit
                </a>
                <ResourceBadge>Article</ResourceBadge>
              </ResourceLink>
              <ResourceLink>
                <a
                  target="_blank"
                  href="https://www.emertxe.com/embedded-systems/c-programming/c-projects/"
                >
          ...
          <ResourceCard>
            ...
            <ResourceCardLinks>
              <ResourceLink>
                <a
                  target="_blank"
                  href="https://www.techbeamers.com/top-c-programming-tips-and-tricks-for-you/"
                >
      ...
      <ResourceSection id="CPP">
        ...
        <ResourceSectionBody>
          <p>
            The C&#43;&#43; programming language was invented in 1979 by Bjarne
            Stroustrup while working on his PhD thesis at Bell Labs. C&#43;&#43;
            was designed to be an extension of the programming language C, hence
            its original name, “C with Classes”. Stroustrup&#39;s goal was to
            add flexibility and OOP (object-oriented programming) to the C
            language. He included features such as classes, strong type
            checking, default function arguments, and basic inheritance. The
            name was changed to C&#43;&#43; in 1983, which derives from the
            &#43;&#43; operator.
          </p>
        </ResourceSectionBody>
          ...
          <ResourceCard>
            ...
            <ResourceCardLinks>
              <ResourceLink>
                <a
                  target="_blank"
                  href="https://www.youtube.com/watch?v=8jLOx1hD3_o"
                >
          ...
          <ResourceCard>
            ...
            <ResourceCardLinks>
              <ResourceLink>
                <a
                  target="_blank"
                  href="https://www.udacity.com/course/c-for-programmers--ud210?irclickid=znLyVwSpsxyIRGAw3s3-n1VaUkDwXRzxqRu5Uo0&irgwc=1&utm_source=affiliate&utm_medium=&aff=2558440&utm_term=&utm_campaign=__&utm_content=&adid=786224"
                >
          ...
          <ResourceCard>
            ...
            <ResourceCardLinks>
              ...
              <ResourceLink>
                <a
                  target="_blank"
                  href="https://ssiddique.info/c-projects-ideas-beginners-experts.html"
                >
          ...
          <ResourceCard>
            ...
            <ResourceCardLinks>
              <ResourceLink>
                <a
                  target="_blank"
                  href="https://betterprogramming.pub/8-neat-c-programming-tricks-you-should-know-be331b828be1"
                >
              ...
              <ResourceLink>
                <a
                  target="_blank"
                  href="https://codeforces.com/blog/entry/74684"
                >
      ...
      <ResourceSection id="Java">
        ...
        <ResourceSectionBody>
          <p>
            ...
            language. It is a general-purpose programming language intended to
            let programmers write once, run anywhere meaning that compiled Java
        ...
        <ResourceSectionLinks>
          ...
          <ResourceCard>
            ...
            <ResourceCardLinks>
              ...
              <ResourceLink>
                <a
                  target="_blank"
                  href="https://www.udacity.com/course/java-programming-basics--ud282"
                >
                  Java Programming BasicsJava Tutorial for Complete Beginners ~
                  Udacity
                </a>
              </ResourceLink>
              <ResourceLink>
                <a
                  target="_blank"
                  href="https://www.udacity.com/course/object-oriented-programming-in-java--ud283"
                >
          ...
          <ResourceCard>
            ...
            <ResourceCardLinks>
              <ResourceLink>
                <a target="_blank" href="https://hackr.io/blog/java-projects">
                  10 Best Java Projects for Beginners 2022 ~ hackr
                </a>
                <ResourceBadge>Article</ResourceBadge>
              </ResourceLink>
              <ResourceLink>
                <a
                  target="_blank"
                  href="https://www.interviewbit.com/blog/java-projects/"
                >
          ...
          <ResourceCard>
            ...
            <ResourceCardLinks>
              <ResourceLink>
                <a
                  target="_blank"
                  href="https://www.geeksforgeeks.org/interesting-and-cool-tricks-in-java/"
                >
              ...
              <ResourceLink>
                <a
                  target="_blank"
                  href="https://blogs.oracle.com/javamagazine/post/java-11-tricks-generics-inheritance-jshell"
                >
      ...
      <ResourceSection id="CSHARP">
        ...
        <ResourceSectionBody>
          <p>
            ...
            applications that run in . NET. C# has its roots in the C family of
            languages and will be immediately familiar to C, C++, Java, and
        ...
        <ResourceSectionLinks>
          ...
          <ResourceCard>
            ...
            <ResourceCardLinks>
              <ResourceLink>
                ...
                >
                  C# Tutorial For Beginners - Learn C# Basics ~ Programming with
                  Mosh
                </a>
              </ResourceLink>
              <ResourceLink>
          ...
          <ResourceCard>
            ...
            <ResourceCardLinks>
              ...
              <ResourceLink>
                <a
                  target="_blank"
                  href="https://www.udemy.com/course/understandingc/?ranMID=39197&ranEAID=JVFxdTr9V80&ranSiteID=JVFxdTr9V80-B2KTq7VSIAY.6Nt9_Xy1bw&LSNPUBID=JVFxdTr9V80&utm_source=aff-campaign&utm_medium=udemyads"
                >
              ...
              <ResourceLink>
                <a
                  target="_blank"
                  href="https://www.udemy.com/course/c-from-beginner-to-pro-build-a-windowsui-app-in-winforms/?ranMID=39197&ranEAID=JVFxdTr9V80&ranSiteID=JVFxdTr9V80-X.phEnJd4UQKI.nJTnkGvg&LSNPUBID=JVFxdTr9V80&utm_source=aff-campaign&utm_medium=udemyads"
                >
          ...
          <ResourceCard>
            ...
            <ResourceCardLinks>
              <ResourceLink>
                <a target="_blank" href="https://cpratt.co/async-tips-tricks/">
      ...
      <ResourceSection id="GO">
        ...
        <ResourceSectionBody>
          <p>
            ...
            Google by Robert Griesemer, Rob Pike, and Ken Thompson.It is
            syntactically similar to C, but with memory safety, garbage
            collection, structural typing,and CSP-style concurrency.It is often
            referred to as Golang because of its former domain name, golang.org,
        ...
        <ResourceSectionLinks>
          ...
          <ResourceCard>
            ...
            <ResourceCardLinks>
              ...
              <ResourceLink>
                <a
                  target="_blank"
                  href="https://www.udemy.com/course/getgoing/?ranMID=39197&ranEAID=CuIbQrBnhiw&ranSiteID=CuIbQrBnhiw-l8y136DdFL9FKYh_1SvyUQ&LSNPUBID=CuIbQrBnhiw&utm_source=aff-campaign&utm_medium=udemyads"
                >
              ...
              <ResourceLink>
                <a target="_blank" href="https://www.tutorialspoint.com/go/">
                  Go Tutorial - Write A WindowsUI Style App Form ~
                  Tutorialspoint
                </a>
              </ResourceLink>
            </ResourceCardLinks>
          ...
          <ResourceCard>
            ...
            <ResourceCardLinks>
              ...
              <ResourceLink>
                ...
                >
                  36 KILLER GOLANG Projects in 36 Different Videos ~ Akhil
                  Sharma
                </a>
                <ResourceBadge>Video</ResourceBadge>
              </ResourceLink>
          ...
          <ResourceCard>
            ...
            <ResourceCardLinks>
              <ResourceLink>
                <a target="_blank" href="https://go101.org/article/tips.html">
                  Go Tips 101 ~ go101
                </a>
                <ResourceBadge>Article</ResourceBadge>
              </ResourceLink>
              <ResourceLink>
                <a target="_blank" href="https://golangtutorial.dev/tips/">
